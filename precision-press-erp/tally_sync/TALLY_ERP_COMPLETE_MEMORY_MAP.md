...
This document serves as the permanent, exhaustive memory record for all TallyPrime ⟷ Precision Press ERP sync flows, file locations, data field mappings, and architectural designs.
