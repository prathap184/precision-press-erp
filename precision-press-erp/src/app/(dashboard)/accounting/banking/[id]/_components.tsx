...
export function MatchToBillSheet({
  ...
  return (
    <Sheet open={!!transaction} onOpenChange={(open) => !open && onClose()}>
      <SheetContent side="right" className="sm:max-w-[95vw] w-full p-0 flex flex-col bg-[#e2ecf8] text-slate-800 border-l border-slate-300 shadow-2xl overflow-hidden font-sans">
