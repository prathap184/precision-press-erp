      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-0 rounded-[2.5rem] overflow-hidden border border-white/10 bg-white/[0.06] backdrop-blur-sm shadow-2xl shadow-black/30">
          ...
          <div className="lg:w-1/2 p-8 lg:p-14 flex flex-col justify-between">
            ...
            <Link href="/customer/new-order" className="group flex items-center justify-center gap-3 w-full bg-white text-indigo-900 py-5 rounded-2xl font-black uppercase tracking-[0.2em] text-xs hover:bg-sky-100 active:scale-95 transition-all shadow-xl">
              Configure Order
