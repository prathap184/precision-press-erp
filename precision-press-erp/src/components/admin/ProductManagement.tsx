          ...
          <table className="w-full text-left border-collapse">
            <thead className="bg-slate-100 border-b border-slate-200">
              <tr>
                ...
                <th className="px-3 py-1.5 text-[10px] font-bold text-slate-500 uppercase tracking-widest border-r border-slate-200">Stock</th>
          ...
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase mb-2">Current Stock</label>
                  <input
                    required
                    type="number"
                    step="0.01"
                    value={editingProduct.current_stock ?? 0}
                    onChange={(e) => setEditingProduct({ ...editingProduct, current_stock: parseFloat(e.target.value) })}
                    className="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 font-bold text-slate-800 bg-slate-50"
                  />
                  <p className="mt-1 text-[10px] text-slate-500">Edit only for initial manual adjustments</p>
                </div>
