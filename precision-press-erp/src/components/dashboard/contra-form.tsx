...
export function ContraForm({ accounts, onSubmit, loading, initial, onCancel, submitLabel }: ContraFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="overflow-x-auto rounded-lg border">
          <div className="grid min-w-[800px] grid-cols-[1fr_1fr_100px_100px_100px_100px_100px_40px] gap-2 border-b bg-muted/50 px-3 py-2 text-xs font-medium text-muted-foreground">
          ...
          {lines.map((line, i) => (
            <div
              key={i}
              className="grid min-w-[800px] grid-cols-[1fr_1fr_100px_100px_100px_100px_100px_40px] gap-2 border-b px-3 py-2 last:border-b-0"
            >
              <Select
          ...
          <div className="grid min-w-[800px] grid-cols-[1fr_1fr_100px_100px_100px_100px_100px_40px] gap-2 border-t bg-muted/30 px-3 py-2">
            <Button
              type="button"
              variant="ghost"
              size="sm"
