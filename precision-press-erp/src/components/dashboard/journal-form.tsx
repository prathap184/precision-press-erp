...
export function JournalForm({ accounts, contacts = [], onSubmit, loading, initial, onCancel, submitLabel }: JournalFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="overflow-x-auto rounded-lg border">
          <div className="grid min-w-[950px] grid-cols-[200px_150px_1fr_100px_100px_100px_100px_100px_40px] gap-2 border-b bg-muted/50 px-3 py-2 text-xs font-medium text-muted-foreground">
            <span>Account</span>
            <span>Contact</span>
          ...
          {lines.map((line, i) => (
            <div
              key={i}
              className="grid min-w-[950px] grid-cols-[200px_150px_1fr_100px_100px_100px_100px_100px_40px] gap-2 border-b px-3 py-2 last:border-b-0"
            >
              <Select
          ...
          <div className="grid min-w-[950px] grid-cols-[200px_150px_1fr_100px_100px_100px_100px_100px_40px] gap-2 border-t bg-muted/30 px-3 py-2">
