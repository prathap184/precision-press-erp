                              ...
                              {(() => {
                                ...
                                return (
                                  <div id={`error-row-${row.id}-product`} className="relative w-full min-w-[220px]">
                                    ...
                                    {isOpen && (
                                      <div className="absolute left-0 top-full mt-1 w-[380px] z-[9999] max-h-72 overflow-y-auto rounded-xl border border-slate-200 bg-white shadow-xl">
                                        {!searchQuery.trim() && (
                                          <div
                                            onMouseDown={(e) => {
                                              e.preventDefault();
                                        ...
                                        {(() => {
                                          ...
                                          return Object.entries(grouped).map(([cat, prods]: [string, any]) => (
                                            <div key={cat}>
                                              <div className="bg-slate-100 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-slate-500 border-b border-slate-200">
                                                {cat.replace(/_/g, ' ')}
                                              </div>
                                              {prods.map((p: any) => {
