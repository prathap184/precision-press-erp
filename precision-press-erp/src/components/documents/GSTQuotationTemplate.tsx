...
export interface GSTQuotationData {
...
interface GSTQuotationTemplateProps {
  template: TaxTemplate;
  quotation: GSTQuotationData;
  forPrint?: boolean;
}
...
export default function GSTQuotationTemplate({ template, quotation, forPrint = false }: GSTQuotationTemplateProps) {
  ...
  const isInterState = !!(quotation.igst_amount && quotation.igst_amount > 0);
  const gstPercent = isInterState
    ? (quotation.igst_rate || 18)
    : ((quotation.cgst_rate || 9) * 2);

  const roundOff = quotation.round_off || 0;
  const emptyRows = Math.max(0, 5 - (quotation.items?.length || 0));
  ...
  return (
    ...
    >
      ...
      {/* Ã¢â€â‚¬Ã¢â€â‚¬ TITLE ROW Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <table style={{ marginBottom: 0 }}>
        <tbody>
          <tr>
            <td style={{ textAlign: 'center', fontWeight: 'bold', fontSize: '13px', borderBottom: 'none', paddingBottom: '2px' }} colSpan={3}>
              Quotation - {quotation.order_type || 'Credit'}
            </td>
      ...
      {/* Ã¢â€â‚¬Ã¢â€â‚¬ e-Invoice / IRN row Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <table style={{ marginBottom: 0 }}>
        <tbody>
          <tr>
          ...
          <tr>
            ...
            <td style={{ fontSize: '9px', border: 'none', fontWeight: 'bold' }} colSpan={2}>{quotation.irn || 'Ã¢â‚¬â€'}</td>
            <td rowSpan={3} style={{ border: '1px solid #000', textAlign: 'center', width: '80px', padding: '4px' }}>
              {quotation.qr_data ? (
                <img src={quotation.qr_data} alt="QR" style={{ width: '70px', height: '70px' }} />
              ) : (
          ...
          <tr>
            ...
            <td style={{ fontSize: '9px', border: 'none', fontWeight: 'bold' }} colSpan={2}>{quotation.ack_number || 'Ã¢â‚¬â€'}</td>
          </tr>
          <tr>
            <td style={{ fontSize: '9px', border: 'none' }}>Ack Date</td>
            <td style={{ fontSize: '9px', border: 'none', fontWeight: 'bold' }} colSpan={2}>{fmtDate(quotation.ack_date) || 'Ã¢â‚¬â€'}</td>
          </tr>
        </tbody>
      </table>

      {/* Ã¢â€â‚¬Ã¢â€â‚¬ COMPANY + INVOICE HEADER Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <table>
        <tbody>
          <tr>
            {/* Company block */}
            ...
            <td style={{ width: '50%', padding: 0 }}>
              <table style={{ width: '100%', height: '100%', borderCollapse: 'collapse' }}>
                <tbody>
                  <tr>
                    <td style={{ fontWeight: 'bold', padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>Quotation No.</td>
                    <td style={{ padding: '3px 5px', fontWeight: 'bold', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>{quotation.quotation_number}</td>
                    <td style={{ fontWeight: 'bold', padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>Dated</td>
                    <td style={{ padding: '3px 5px', fontWeight: 'bold', borderBottom: '1px solid #000' }}>{fmtDate(quotation.quotation_date)}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>Delivery Note</td>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>{quotation.dispatch?.delivery_note || ''}</td>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>Mode/Terms of Payment</td>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000' }}>{quotation.mode_of_payment || ''}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>Buyer's Order No.</td>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>{quotation.buyer_order_no || quotation.buyer_order_number || ''}</td>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>Buyer's Order Date</td>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000' }}>{fmtDate(quotation.buyer_order_date)}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>Transporter</td>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>{quotation.dispatch?.transporter_name || ''}</td>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>Delivery Note Date</td>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000' }}>{fmtDate(quotation.dispatch?.delivery_note_date)}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>Despatched through</td>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>{quotation.dispatch?.dispatch_through || ''}</td>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000', borderRight: '1px solid #000' }}>Destination</td>
                    <td style={{ padding: '3px 5px', borderBottom: '1px solid #000' }}>{quotation.dispatch?.destination || ''}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: '3px 5px', borderRight: '1px solid #000' }}>LR Number & Date</td>
                    <td style={{ padding: '3px 5px', borderRight: '1px solid #000' }}>
                      {quotation.dispatch?.lr_number ? `${quotation.dispatch.lr_number} / ${fmtDate(quotation.dispatch.lr_date)}` : ''}
                    </td>
                    <td style={{ padding: '3px 5px', borderRight: '1px solid #000' }}>Motor Vehicle No.</td>
                    <td style={{ padding: '3px 5px' }}>{quotation.dispatch?.vehicle_number || ''}</td>
                  </tr>
                </tbody>
              </table>
            </td>
      ...
      {/* Ã¢â€â‚¬Ã¢â€â‚¬ BUYER + CONSIGNEE Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <table>
        <tbody>
          <tr>
            <td style={{ width: '50%', verticalAlign: 'top', padding: '5px 8px' }}>
              ...
              <div style={{ fontWeight: 'bold', fontSize: '11px' }}>{quotation.buyer_name}</div>
              <div style={{ whiteSpace: 'pre-line' }}>{quotation.buyer_address}</div>
              {quotation.buyer_phone && <div>{quotation.buyer_phone}</div>}
              {quotation.buyer_place_of_supply && <div>Place of Supply : {quotation.buyer_place_of_supply}</div>}
              <div>GSTN No. : {quotation.buyer_gstin || 'Unregistered'}</div>
            </td>
            <td style={{ width: '50%', verticalAlign: 'top', padding: '5px 8px' }}>
              <div style={{ fontSize: '9px', fontWeight: 'bold', marginBottom: '2px' }}>Consignee's Name &amp; Address</div>
              <div style={{ fontWeight: 'bold', fontSize: '11px' }}>{quotation.consignee_name}</div>
              <div style={{ whiteSpace: 'pre-line' }}>{quotation.consignee_address}</div>
              {quotation.consignee_phone && <div>{quotation.consignee_phone}</div>}
              {quotation.consignee_place_of_supply && <div>Place of Supply : {quotation.consignee_place_of_supply}</div>}
              <div>GSTN No. : {quotation.consignee_gstin || 'Unregistered'}</div>
            </td>
          </tr>
        </tbody>
      </table>

      {/* Ã¢â€â‚¬Ã¢â€â‚¬ ITEMS TABLE Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <table>
        <thead>
        ...
        <tbody>
          {(quotation.items || []).map((item, i) => (
            <tr key={i}>
              ...
              <td style={{ textAlign: 'right' }}>{fmt(item.amount)} Ã¢â€šÂ¹</td>
            </tr>
          ))}
          {/* Empty rows */}
          ...
          {/* Ã¢â€â‚¬Ã¢â€â‚¬ TOTALS SECTION INSIDE TABLE Ã¢â€â‚¬Ã¢â€â‚¬ */}
          <tr>
            <td colSpan={11} style={{ textAlign: 'right', fontWeight: 'bold', backgroundColor: '#f9f9f9' }}>
              Total Amount
            </td>
            <td style={{ textAlign: 'right', fontWeight: 'bold' }}>
              {fmt(quotation.grand_total)} Ã¢â€šÂ¹
            </td>
          </tr>
        </tbody>
      </table>

      {/* Ã¢â€â‚¬Ã¢â€â‚¬ AMOUNT IN WORDS + GST SUMMARY Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <table>
        <tbody>
          <tr>
            <td style={{ width: '50%', verticalAlign: 'top', padding: '4px 6px' }}>
              <div>
                ...
                <span>{quotation.amount_in_words || numberToWordsINR(quotation.grand_total)}</span>
              </div>
            </td>
            <td style={{ width: '50%', verticalAlign: 'top', padding: '4px 6px' }}>
              ...
              <span>
                {isInterState
                  ? numberToWordsINR(quotation.igst_amount || 0)
                  : numberToWordsINR((quotation.cgst_amount || 0) + (quotation.sgst_amount || 0))}
              </span>
            </td>
          </tr>
        </tbody>
      ...
      {/* Ã¢â€â‚¬Ã¢â€â‚¬ GST CALCULATION TABLE Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <table>
        <thead>
          <tr style={{ backgroundColor: '#f0f0f0' }}>
        ...
        <tbody>
          {(quotation.tax_items?.length ? quotation.tax_items : [{
          ...
          <tr style={{ fontWeight: 'bold', backgroundColor: '#f0f0f0' }}>
            ...
            <td style={{ textAlign: 'right' }}>{fmt(quotation.taxable_value)}</td>
            {isInterState ? (
              <>
                <td></td>
                <td style={{ textAlign: 'right' }}>{fmt(quotation.igst_amount || 0)}</td>
              </>
            ) : (
              <>
                <td></td>
                <td style={{ textAlign: 'right' }}>{fmt(quotation.cgst_amount || 0)}</td>
                <td></td>
                <td style={{ textAlign: 'right' }}>{fmt(quotation.sgst_amount || 0)}</td>
              </>
            )}
            <td style={{ textAlign: 'right' }}>
              {fmt(isInterState
                ? (quotation.igst_amount || 0)
                : (quotation.cgst_amount || 0) + (quotation.sgst_amount || 0))}
            </td>
          </tr>
        </tbody>
      </table>

      {/* Ã¢â€â‚¬Ã¢â€â‚¬ REMARKS + BANK DETAILS Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <table>
        <tbody>
          <tr>
      ...
      {/* Ã¢â€â‚¬Ã¢â€â‚¬ SIGNATURES Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <table>
        <tbody>
          <tr>
