...
export const Header = () => {
  ...
  return (
    <header className="h-11 mx-3 md:mx-4 mt-1.5 mb-0.5 px-3 md:px-4 bg-white/40 backdrop-blur-2xl border border-white/60 rounded-xl shadow-[0_2px_16px_rgba(0,0,0,0.02)] sticky top-1 z-40 flex items-center justify-between transition-all">
      <div className="flex items-center gap-2.5">
        <button 
          onClick={() => window.history.back()}
          className="w-7 h-7 rounded-lg bg-white/60 border border-white/70 shadow-xs flex items-center justify-center text-slate-700 hover:text-blue-600 hover:bg-white hover:scale-105 transition-all backdrop-blur-md cursor-pointer shrink-0"
          title="Back"
        >
          <ArrowLeft size={13} />
        </button>
        <div>
          ...
          <div className="flex items-center gap-1.5 -mt-0.5">
            <span className="text-[11px] md:text-xs font-medium text-slate-500">Pixel Marketing Intelligence / Terminal Alpha</span>
          </div>
        </div>
      </div>

      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 hidden md:block">
        <div className="px-3 py-1 rounded-full bg-emerald-500/10 backdrop-blur-md border border-emerald-500/20 flex items-center gap-1.5 shadow-xs">
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-1.5 pr-2.5 border-r border-white/60">
          <button className="w-7 h-7 rounded-xl bg-white/40 border border-white/50 shadow-xs flex items-center justify-center text-slate-600 hover:text-blue-600 hover:bg-white/70 hover:scale-105 transition-all backdrop-blur-md relative" title="Notifications">
            <Bell size={14} />
            <span className="absolute top-1.5 right-1.5 w-1.5 h-1.5 bg-red-500 rounded-full ring-2 ring-white" />
          </button>
          <button className="w-7 h-7 rounded-xl bg-white/40 border border-white/50 shadow-xs flex items-center justify-center text-slate-600 hover:text-blue-600 hover:bg-white/70 hover:scale-105 transition-all backdrop-blur-md" title="History">
            <History size={14} />
          </button>
          <button className="w-7 h-7 rounded-xl bg-white/40 border border-white/50 shadow-xs flex items-center justify-center text-slate-600 hover:text-blue-600 hover:bg-white/70 hover:scale-105 transition-all backdrop-blur-md" title="Print View">
            <Printer size={14} />
          </button>
        </div>
        ...
        <div className="flex items-center gap-1.5 pr-2.5 border-r border-white/60">
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 rounded-xl text-[11px] font-semibold text-slate-700 bg-white/40 border border-white/50 hover:bg-red-50/80 hover:text-red-600 hover:border-red-200 transition-all backdrop-blur-md shadow-xs"
          >
            <span className="w-4 h-4 rounded-md bg-red-50 flex items-center justify-center flex-shrink-0 text-red-500">
        ...
        <div className="flex items-center gap-2.5 group cursor-pointer">
          ...
          {(simulatedRole || viewMode === 'CUSTOMER') && (
            <button 
              ...
              className="px-2 py-0.5 bg-blue-50/90 text-blue-700 border border-blue-200/70 rounded-lg text-[10px] font-semibold hover:bg-blue-100 transition-colors backdrop-blur-md shadow-xs"
            >
              Reset
            </button>
          )}
          <div className="w-7 h-7 rounded-xl overflow-hidden border-2 border-white/80 shadow-xs transition-all group-hover:border-blue-400 flex-shrink-0">
            <img 
